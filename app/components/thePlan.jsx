...
export default function ThePlan({ t }) {
  ...
  return (
    <div className="z-10 flex flex-col items-center justify-center text-center gap-8 px-6 -translate-y-[30vh]">
      <h1>{t.plan}</h1>
      ...
      <div className="flex flex-col gap-24">
        <div className="flex flex-col gap-2 items-center">
          ...
          <button
            className="px-6 py-3 rounded-full bg-[#ecececa6] shadow-2xl w-fit"
            onClick={() =>
              onClick({
